...
class VerifyView(discord.ui.View):
    ...
    async def verify_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if not role:
            await interaction.response.send_message("Verification role missing.", ephemeral=True); return
        try:
...
class VerifyCog(commands.Cog):
    ...
    @app_commands.command(name="verify_panel", description="Post the verify button panel.")
